...
function requireBindings() {
  ...
  (function(module, exports) {
    var fs = require$$0, path = require$$1$1, fileURLToPath2 = requireFileUriToPath(), join2 = path.join, dirname2 = path.dirname, exists = fs.accessSync && function(path2) {
      try {
        fs.accessSync(path2);
      } catch (e) {
        return false;
...
const __dirname$1 = join(__filename$2, "..");
const dbPath = join(__dirname$1, "enigmai.db");
...
ipcMain.handle("riddle:startAuto", () => {
  if (!riddleTimer) {
    riddleTimer = setInterval(generateAndSaveRiddle, 5e3);
  }
